  ...
  async function runOptimize() {
    ...
    try {
      ...
      if (MODULE_CALC.solutions.length === 0) {
        MODULE_CALC.error = "No valid solutions found, please adjust your filters";
      }
    } catch (e) {
...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-xl font-bold text-foreground">Mod Calculator</h1>
        <p class="text-sm text-muted-foreground">Calculate and optimise mod configurations</p>
      </div>
    </div>
