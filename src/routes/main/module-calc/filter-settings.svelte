...
<div class="rounded-lg border border-border/60 bg-card/40 p-4 space-y-4">
  ...
  <div class="space-y-2">
    <div class="text-sm text-muted-foreground">Target attributes — only mods with the selected attributes will be calculated (useful for pre-filtering when mod count exceeds 1000)</div>
