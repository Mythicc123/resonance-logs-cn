...
<div class="space-y-6">
  <div class="rounded-lg border border-border/60 bg-card/40 p-4 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] space-y-4">
    <div>
      ...
      <p class="text-xs text-muted-foreground">Displays counter and Buff text rows (no icons)</p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
      <label class="text-xs text-muted-foreground">
        Row Gap: {customPanelStyle.gap}px
        <input
          class="w-full mt-1"
          type="range"
          min="0"
      ...
      <label class="text-xs text-muted-foreground">
        Name–Value Gap: {customPanelStyle.columnGap}px
        <input
          class="w-full mt-1"
          type="range"
          min="0"
  ...
  <div class="rounded-lg border border-border/60 bg-card/40 p-4 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] space-y-3">
    <div class="space-y-1">
      ...
      <p class="text-xs text-muted-foreground">Only adds to the custom panel text area</p>
    </div>
    <input
